...
char *v7trap_name[] = {
    "indir",   "exit",    "fork",    "read",    "write",   "open",    "close",
    "wait",    "creat",   "link",    "unlink",  "exec",    "chdir",   "time",
    "mknod",   "chmod",   "chown",   "break",   "stat",    "lseek",   "getpid",
    "mount",   "umount",  "setuid",  "getuid",  "stime",   "ptrace",  "alarm",
    "fstat",   "pause",   "utime",   "stty",    "gtty",    "access",  "nice",
    "ftime",   "sync",    "kill",    "unknown", "unknown", "unknown", "dup",
    "pipe",    "times",   "prof",    "unknown", "setgid",  "getgid",  "signal",
    "unknown", "unknown", "acct",    "phys",    "lock",    "ioctl",   "unknown",
    "unknown", "unknown", "unknown", "exece",   "umask",   "chroot",
};
